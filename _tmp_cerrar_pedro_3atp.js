...
const AUDIT_PATH = path.join(ROOT, '_tmp_3atp_auditoria.json');
const ROSTER_PATH = path.join(ROOT, 'carga_3A_TP.txt');
const REPORT_DIR = path.join(ROOT, 'lecturas', 'adminprofe', 'reportes');
const CSV_PATH = path.join(REPORT_DIR, 'Planilla_Pedro_Paramo_3A_TP_2026.csv');
const HTML_PATH = path.join(REPORT_DIR, 'Informe_Final_Pedro_Paramo_3A_TP_2026.html');
const LOCAL_HTML_PATH = path.join(REPORT_DIR, 'Informe_Local_Con_Individuales_Pedro_Paramo_3A_TP_2026.html');
...
const SCORES_3A = {
  'ALFARO VERGARA DIEGO IGNACIO': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['3/3', 5, 'p25_full'] },
  'AMARO HERRERA MICHAELL ANDRES': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'ARAYA PENA FRANCO JAVIER': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'AYALA MORA OMAR FRANCISCO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['3/3', 5, 'p25_full'] },
  'BARRIOS SAAVEDRA JOAQUIN ALONSO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['1/3', 2, 'p25_partial'] },
  'BASCUR LAGOS PABLO ANDRES': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['1/3', 1, 'p17_partial'], pedro_25: ['1/3', 2, 'p25_partial'] },
  'CANALES MORALES BRANDON MANUEL': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['1/3', 2, 'p25_partial'] },
  'CASTRO PARRA DAMIAN EDUARDO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['1/3', 2, 'p25_offtopic'] },
  'CHAMORRO ROJAS ALEJANDRO MAXIMILIANO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'CORDERO VILCHES CRISTOBAL ANDRES': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'DIAZ DIAZ FRANCO AGUSTIN EMILIO': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'DIAZ GUAJARDO ALEJANDRO JOSE': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['1/3', 2, 'p25_partial'] },
  'DORADOR OLAVE FREDDY EMILIANO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['3/3', 5, 'p25_full'] },
  'DURAN LANDABUR SEBASTIAN IGNACIO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['1/3', 2, 'p25_partial'] },
  'FUENTES NAVARRETE FRANCO ANTONIO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['1/3', 2, 'p25_offtopic'] },
  'GAETE MALDONADO SALVADOR FERNANDO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['1/3', 2, 'p25_partial'] },
  'HERNANDEZ AGUILERA MATIAS IGNACIO': { pedro_11: ['1/3', 1, 'p11_partial'], pedro_17: ['1/3', 1, 'p17_partial'], pedro_25: ['1/3', 1, 'p25_partial'] },
  'HERRERA MUNOZ ERICK GABRIEL': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['3/3', 5, 'p25_full'] },
  'JARA LANDERO PABLO ANTONIO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['1/3', 1, 'p17_partial'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'MARTINEZ JARA KEVIN ALEJANDRO': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['3/3', 5, 'p25_full'] },
  'MELGAREJO QUIJON ROBERTO JOSE': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['1/3', 2, 'p25_partial'] },
  'MERCADO MENDEZ FREDERIC ALEJANDRO': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['3/3', 5, 'p25_full'] },
  'MONDACA SEGUEL MATIAS ALEJANDRO': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['3/3', 5, 'p25_full'] },
  'NAVARRO AMARO THOMAS SEBASTIAN': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'PULGAR SAAVEDRA BENJAMIN IGNACIO': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'PURCHES VALENZUELA LUCAS VICENTE': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'RETAMAL MENA DIEGO IGNACIO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'RODRIGUEZ CASTRO EMILIO PEDRO': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'RUIZ MEJIAS MAXIMO ETEEN SANTHY': { pedro_11: ['1/3', 1, 'p11_partial'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['3/3', 5, 'p25_full'] },
  'RUIZ SALINAS VICENTE ALEJANDRO': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['0/3', 0, 'p17_blank'], pedro_25: ['0/3', 0, 'p25_blank'] },
  'SAAVEDRA RETAMAL BASTIAN ISRAEL': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'SALAS CHAPARRO RICARDO ANTONIO': { pedro_11: ['1/3', 1, 'p11_partial'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'SAN MARTIN VALENZUELA AGUSTIN LEON IGNACIO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['1/3', 2, 'p25_partial'] },
  'SANCHEZ RODRIGUEZ VICENTE BASTIAN': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'SANHUEZA ARACIBIA MARTIN JAVIER': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['3/3', 5, 'p25_full'] },
  'SEPULVEDA GONZALEZ TOMAS LUCIANO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'TORRES CASTILLO DAMIAN EMILIO': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'VALDES CHANDIA JUAN PABLO ENRIQUE': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['1/3', 2, 'p25_partial'] },
  'VALENZUELA ROJAS TOMAS IGNACIO': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['3/3', 5, 'p25_full'] },
  'VALLE GONZALEZ MAXIMILIANO JUAN ALONSO': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['2/3', 3, 'p25_mid'] },
  'VERDUGO RUIZ BENJAMIN ARIEL': { pedro_11: ['2/3', 3, 'p11_mid'], pedro_17: ['2/3', 2, 'p17_mid'], pedro_25: ['1/3', 2, 'p25_offtopic'] },
  'YEVENES NOVOA VICENTE ALEXANDER': { pedro_11: ['3/3', 4, 'p11_full'], pedro_17: ['3/3', 3, 'p17_full'], pedro_25: ['3/3', 5, 'p25_full'] }
};
...
(async () => {
  try {
    ...
    const html = '<!DOCTYPE html>'
      ...
      + '<title>Informe Final Pedro Paramo 3A-TP 2026</title>'
      + '<style>'
      ...
      + '<p>Sesiones: regular y PIE individual · Escala 1.0 a 7.0 · Exigencia 60% · Total 37 pts (25 auto + 12 desarrollo)</p>'
