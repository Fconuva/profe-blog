...
"""
Generador de PDF para Dossier Historia y Geografía Media
ECEP 2025
"""
...
def generar_html_completo(archivo_historia):
    """Genera el HTML completo del dossier"""
    
    with open(archivo_historia, 'r', encoding='utf-8') as f:
        contenido = f.read()
...
<head>
    ...
    <title>Dossier Historia y Geografía Media - ECEP 2025</title>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .cover-page {{ min-height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; background: linear-gradient(135deg, #dc2626 0%, #ef4444 100%); color: white; padding: 60px 40px; }}
        ...
        h1 {{ color: #dc2626; font-size: 2.5rem; margin: 2rem 0 1.5rem 0; border-bottom: 4px solid #ef4444; padding-bottom: 0.5rem; }}
        h2 {{ color: #dc2626; font-size: 2rem; margin: 1.8rem 0 1rem 0; border-left: 6px solid #ef4444; padding-left: 1rem; }}
        table {{ width: 100%; border-collapse: collapse; margin: 1.5rem 0; }}
        table th {{ background: #dc2626; color: white; padding: 12px; }}
...
<body>
    <div class="cover-page no-print">
        ...
        <h1>Dossier Historia y Geografía</h1>
    ...
    <div class="footer no-print">
        <p><strong>Dossier Historia y Geografía - ECEP 2025</strong></p>
...
def main():
    print("🌎 Generando Dossier Historia y Geografía Media...")
    archivo = Path("evaluaciones/educacion-media/estudio/dossier-historia-media/index.njk")
    ...
    output = "DOSSIER_HISTORIA_MEDIA_COMPLETO.html"
    ...
    print("\n📋 Guarda como: dossieres-pdf/DOSSIER_HISTORIA_MEDIA.pdf")
