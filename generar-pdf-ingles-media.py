...
"""
Generador de PDF para Dossier Inglés Media
ECEP 2025
"""
...
def generar_html_completo(archivo_ingles):
    with open(archivo_ingles, 'r', encoding='utf-8') as f:
        contenido = f.read()
...
<head>
    ...
    <title>Dossier Inglés Media - ECEP 2025</title>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .cover-page {{ min-height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; background: linear-gradient(135deg, #7c3aed 0%, #a78bfa 100%); color: white; padding: 60px 40px; }}
        ...
        h1 {{ color: #7c3aed; font-size: 2.5rem; margin: 2rem 0 1.5rem 0; border-bottom: 4px solid #a78bfa; padding-bottom: 0.5rem; }}
        h2 {{ color: #7c3aed; font-size: 2rem; margin: 1.8rem 0 1rem 0; border-left: 6px solid #a78bfa; padding-left: 1rem; }}
        table {{ width: 100%; border-collapse: collapse; margin: 1.5rem 0; }}
        table th {{ background: #7c3aed; color: white; padding: 12px; }}
...
<body>
    ...
    <div class="footer no-print">
        <p><strong>Dossier Inglés - ECEP 2025</strong></p>
...
def main():
    print("🇬🇧 Generando Dossier Inglés Media...")
    archivo = Path("evaluaciones/educacion-media/estudio/dossier-ingles-media.njk")
    ...
    output = "DOSSIER_INGLES_MEDIA_COMPLETO.html"
    ...
    print("\n📋 Guarda como: dossieres-pdf/DOSSIER_INGLES_MEDIA.pdf")
