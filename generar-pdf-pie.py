...
"""
Generador de PDF para Dossier PIE - Educación Especial
ECEP 2025 - Programa Integración Escolar
"""
...
def generar_html_completo(archivo_dea):
    with open(archivo_dea, 'r', encoding='utf-8') as f:
        contenido = f.read()
...
<head>
    ...
    <title>Dossier PIE - Educación Especial - ECEP 2025</title>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .cover-page {{ min-height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; background: linear-gradient(135deg, #6366f1 0%, #818cf8 100%); color: white; padding: 60px 40px; }}
        ...
        h1 {{ color: #6366f1; font-size: 2.5rem; margin: 2rem 0 1.5rem 0; border-bottom: 4px solid #818cf8; padding-bottom: 0.5rem; }}
        h2 {{ color: #6366f1; font-size: 2rem; margin: 1.8rem 0 1rem 0; border-left: 6px solid #818cf8; padding-left: 1rem; }}
        table {{ width: 100%; border-collapse: collapse; margin: 1.5rem 0; }}
        table th {{ background: #6366f1; color: white; padding: 12px; }}
...
<body>
    <div class="cover-page no-print">
        ...
        <h1>Dossier PIE</h1>
        <p class="subtitle" style="font-size: 1.8rem;">Programa Integración Escolar</p>
        <div class="metadata" style="margin-top: 3rem;">
            <p><strong>ECEP 2025 - Educación Especial</strong></p>
            <p>DEA • TEL • TEA • DI • DM</p>
    ...
    <div class="footer no-print">
        <p><strong>Dossier PIE - Educación Especial - ECEP 2025</strong></p>
...
def main():
    print("♿ Generando Dossier PIE - Educación Especial...")
    archivo = Path("evaluaciones/educacion-especial/estudio/dossier-dea.njk")
    ...
    output = "DOSSIER_PIE_EDUCACION_ESPECIAL_COMPLETO.html"
    ...
    print("\n📋 Guarda como: dossieres-pdf/DOSSIER_PIE_EDUCACION_ESPECIAL.pdf")
