# -*- coding: utf-8 -*-
"""
Script para generar bloques HTML de contexto para las primeras 10 preguntas
Estilo similar a las preguntas 51-58
"""

import json

# Leer contextos
with open('contextos_mejorados_1_10.json', 'r', encoding='utf-8') as f:
    contextos = json.load(f)

# Generar HTML para cada contexto
html_contexts = {}

for key in ['parv-01', 'parv-02', 'parv-03', 'parv-04', 'parv-05', 
            'parv-06', 'parv-07', 'parv-08', 'parv-09', 'parv-10']:
...
with open('contextos_html_1_10.json', 'w', encoding='utf-8') as f:
    json.dump(html_contexts, f, ensure_ascii=False, indent=2)

print("✓ HTML de contextos generado exitosamente")
print(f"✓ Guardado en: contextos_html_1_10.json")
