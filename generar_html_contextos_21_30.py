# -*- coding: utf-8 -*-
"""
Generar HTML para contextos de preguntas 21-30
"""

import json

# Cargar contextos
with open('contextos_mejorados_21_30.json', 'r', encoding='utf-8') as f:
...
# Guardar
with open('contextos_html_21_30.json', 'w', encoding='utf-8') as f:
    json.dump(html_contextos, f, ensure_ascii=False, indent=2)

print(f"\n✓ {len(html_contextos)} bloques HTML generados")
print("✓ Guardado en: contextos_html_21_30.json")
