# Script para insertar contextos en planData (preguntas 21-30)
$archivo = "evaluaciones\educacion-parvularia\pruebas\parv-nt\index.njk"
$content = Get-Content $archivo -Raw -Encoding UTF8

# Cargar contextos
$contextos = Get-Content "contextos_mejorados_21_30.json" -Raw -Encoding UTF8 | ConvertFrom-Json
...
Write-Host "`n10 contextos pedagógicos insertados (preguntas 21-30)"
