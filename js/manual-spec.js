...
window.MANUAL_SPEC = {
  ...
  "hospitalaria": {
    ...
    "referente": "Núcleo o asignatura del nivel de tu inscripción (Parvularia, Básica o Media)",
    "oaPicker": { "modo": "libre" },
    "aviso": "Tu manual tiene tres diferencias grandes con el resto y conviene que las tengas claras desde ya. Primero: la Tarea 1 caracteriza a UN estudiante, no a un curso, y describe TRES clases implementadas, que pueden ser consecutivas o no y durar distinto. Segundo: tu Módulo 2 es un REGISTRO DE AUDIO de 20 a 45 minutos, no un video, y no necesitas grabar el cierre. Tercero: tu Tarea 3 no es socioemocional como en los otros manuales, es una reflexión sobre tus propias creencias en Pedagogía Hospitalaria y sobre tus fortalezas y necesidades profesionales. Los Módulos 1 y 2 son independientes: puedes hacerlos con el mismo estudiante o con otro, en distinta modalidad, núcleo o asignatura.",
    "duracionM1": "Tres clases implementadas, pueden ser consecutivas o no y de distinta duración",
    "duracionGrabada": "Registro de AUDIO de 20 a 45 minutos (no necesitas incluir el cierre)",
    "camposEspeciales": [
      { "id": "modalidad", "label": "Modalidad en la que trabajas", "tipo": "select", "obligatorio": true, "ayuda": "El manual pide declararla explícitamente en el Módulo 1: señala dónde se realizaron las clases que vas a describir.", "ejemplo": "Sala cama", "opciones": ["Aula hospitalaria","Sala cama","Atención domiciliaria","Aula hospitalaria y sala cama","Sala cama y atención domiciliaria","Aula hospitalaria, sala cama y atención domiciliaria"] },
      { "id": "nivelInscripcion", "label": "Nivel por el que estás inscrito/a", "tipo": "select", "obligatorio": true, "ayuda": "Define el referente curricular de tus tareas.", "ejemplo": "Educación Básica", "opciones": ["Educación Parvularia","Educación Básica","Educación Media","Pedagogía Hospitalaria Educación Especial"] },
      { "id": "nucleoAsignatura", "label": "Núcleo o asignatura del Módulo 1", "tipo": "text", "obligatorio": true, "ayuda": "En Parvularia es un núcleo (por ejemplo Lenguaje Verbal); en Básica o Media, una asignatura.", "ejemplo": "Lenguaje Verbal" },
      { "id": "oa", "label": "OA u objetivo con el que trabajarás (transcrito)", "tipo": "textarea", "obligatorio": true, "ayuda": "Si por las características de tu estudiante estás empleando un objetivo de un curso inferior, puedes presentarlo así: el manual dice expresamente que eso NO afecta tu evaluación.", "ejemplo": "OA 04: comprender narraciones escuchadas, extrayendo información explícita con apoyo de las ilustraciones." },
      { "id": "estudianteM1", "label": "Tu estudiante del Módulo 1", "tipo": "textarea", "obligatorio": true, "ayuda": "El manual caracteriza a UN estudiante, no a un grupo. Cuéntanos su edad, nivel, cuánto lleva de estancia, qué favorece y qué dificulta su aprendizaje.", "ejemplo": "Niño de 2° básico, tres meses de tratamiento, se cansa a los 20 minutos, se engancha con lo visual y le cuesta escribir por la vía." },
      { "id": "estudianteM2", "label": "¿El Módulo 2 será con el mismo estudiante o con otro?", "tipo": "textarea", "obligatorio": false, "ayuda": "Los Módulos 1 y 2 son independientes: pueden ser el mismo estudiante o distinto, y en otra modalidad, núcleo o asignatura. Si es otro, cuéntanos de él o ella.", "ejemplo": "Con otra estudiante, de kínder, en atención domiciliaria." }
    ],
    "preguntasRubrica": [
      { "id": "caracterizacionHosp", "label": "¿Qué características de tu estudiante favorecen o dificultan su aprendizaje?", "ayuda": "Subtarea 1.1. El manual pide considerar edad, conocimientos, intereses, diagnóstico y duración de la estancia, para adecuar las decisiones pedagógicas a su realidad.", "ejemplo": "Lleva tres meses hospitalizado y perdió continuidad, pero conserva muy buena comprensión oral; la fatiga del tratamiento le limita las sesiones a unos 20 minutos.", "tipo": "textarea" },
      { "id": "adecuacionClases", "label": "¿Cómo adecuaste las tres clases a las características de tu estudiante?", "ayuda": "Es la rúbrica central del Módulo 1, 'Adecuación de las clases a las características de su estudiante'.", "ejemplo": "Partí cada sesión con un logro corto y visible, dejé cada clase cerrada en sí misma por si faltaba a la siguiente, y usé material que no requiere estar sentado.", "tipo": "textarea" },
      { "id": "monitoreoHosp", "label": "¿Cómo monitoreaste el aprendizaje y qué hiciste con esa información?", "ayuda": "Tarea 2: monitoreo, análisis de los desempeños y uso de esa evidencia para favorecer el aprendizaje.", "ejemplo": "Registro en una pauta breve por sesión, porque no siempre vuelvo a ver al mismo estudiante; con eso decido si retomo o avanzo.", "tipo": "textarea" },
      { "id": "creenciasPractica", "label": "¿Qué creencias tuyas sobre la Pedagogía Hospitalaria has puesto en cuestión?", "ayuda": "Subtarea 3.1, propia de tu manual. NO es una reflexión socioemocional como en los otros: es una mirada crítica a tus propias creencias sobre esta práctica.", "ejemplo": "Creía que en el hospital lo pedagógico venía después de lo emocional, y me di cuenta de que la clase es justamente lo que les devuelve rutina y control.", "tipo": "textarea" },
      { "id": "generoGrabada", "label": "¿Qué haces para promover la equidad de género en el aula?", "ayuda": "Es una de las rúbricas evaluadas del Módulo 2.", "ejemplo": "Reparto los turnos y las responsabilidades por igual y cuido que los ejemplos no asocien capacidades a un género.", "tipo": "textarea" }
    ],
    "ejemplosCampoComun": {
      "conocimientosPrevios": "Trae aprendizajes dispares según cuánto lleva fuera de su escuela; conserva lo oral pero perdió continuidad en lo escrito.",
      "fortalezas": "Se compromete cuando la actividad tiene sentido y le devuelve rutina y control sobre algo propio.",
      "dificultades": "La fatiga y los horarios de tratamiento acortan las sesiones; la asistencia es irregular por razones de salud.",
      "oa": "Núcleo o asignatura del nivel de inscripción. Si usas el objetivo de un curso inferior por las características de tu estudiante, el manual lo permite y no afecta tu evaluación.",
      "unidad": "Tres clases implementadas, que pueden ser consecutivas o no y durar distinto."
    }
  },
